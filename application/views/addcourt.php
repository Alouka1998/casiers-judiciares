...
<head>
  ...
  <title>Casier Judiciaire | Insertion de tribunal </title>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card-header">
            <h3 class="card-title">Formulaire d'insersion de tribunal</h3>
          </div>
           <form enctype="multipart/form-data" action="<?=base_url('index.php/main/savecourt/')?>" class="checkout" method="post" name="checkout">
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
               ...
               <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Commune: </label>
                  <input type="text" name="Commune" required="" class="form-control">
                </div>
              </div>
            </div>
