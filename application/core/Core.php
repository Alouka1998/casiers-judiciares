...
class Core {
	...
	function validate_post($data)
	{
		...
		return !empty($data['localhost']) && !empty($data['root']) && !empty($data['trocdata']);
	}
    ...
    {
        // Config path
		$template_path 	= '../config/addchat.php';
